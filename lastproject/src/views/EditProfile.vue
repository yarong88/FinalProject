...
export default {
  ...
  methods: {
    ...
    value() {
      axios.get("/profiler/" + this.user.id).then((res) => {
        this.user.nickname = res.data.user_nickname;
        this.user.email = res.data.user_email;
        this.user.birth = res.data.user_birth;
        this.user.gender = res.data.user_gender;
        this.user.hobby = res.data.user_hobby;
        this.user.profile = res.data.user_profile;
      });
    },
    readURL(event) {
